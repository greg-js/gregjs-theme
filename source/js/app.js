...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContainerTop = function (_Component) {
	  _inherits(ContainerTop, _Component);

	  function ContainerTop(props) {
	    _classCallCheck(this, ContainerTop);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ContainerTop).call(this, props));

	    _this.state = {
	      isMenuActive: false
	    };

	    _this.toggleMenuClass = _this.toggleMenuClass.bind(_this);
	    return _this;
	  }

	  _createClass(ContainerTop, [{
	    key: 'toggleMenuClass',
	    ...
	    value: function render() {
	      return (0, _preact.h)(
	        'div',
	        { id: 'container-top' },
	        (0, _preact.h)(_mobileMenu2.default, { toggleMenu: this.toggleMenuClass }),
	        (0, _preact.h)(_header2.default, { isMenuActive: this.state.isMenuActive })
	      );
	    }
	  }]);
	...
	(0, _preact.render)((0, _preact.h)(ContainerTop, null), container, containerTop);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MobileMenu = function MobileMenu(_ref) {
	  ...
	  return (0, _preact.h)(
	    ...
	    (0, _preact.h)('i', { 'class': 'icon-reorder icon-large' })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function Header(_ref) {
	  var isMenuActive = _ref.isMenuActive;
	  return (0, _preact.h)(
	    'header',
	    { id: 'header' },
	    (0, _preact.h)(
	    ...
	    (0, _preact.h)(_nav2.default, { isMenuActive: isMenuActive })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _projectsMenu = __webpack_require__(7);
	...
	var Nav = function Nav(_ref) {
	  ...
	  return (0, _preact.h)(
	    'nav',
	    { 'class': isMenuActive ? 'nav active' : 'nav' },
	    (0, _preact.h)(
	      'ul',
	      { 'class': 'menu-top' },
	      (0, _preact.h)(
	      ...
	      (0, _preact.h)(
	        'li',
	        { 'class': 'menu-item' },
	        (0, _preact.h)(_projectsMenu2.default, null)
	      ),
	      (0, _preact.h)(
	        'li',
	        { 'class': 'menu-item' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_Component) {
	  ...
	  function Header(props) {
	    ...
	    _this.onClickProjects = _this.onClickProjects.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Header, [{
	    ...
	    key: 'renderSubmenu',
	    value: function renderSubmenu(items) {
	      return items.map(function (item) {
	        return (0, _preact.h)(
	          'a',
	          { href: item.url, 'class': 'submenu-item' },
	          (0, _preact.h)(
	            'li',
	            null,
	            item.title
	    ...
	    value: function render() {
	      ...
	      return (0, _preact.h)(
	        'div',
	        { onClick: function onClick() {
	            return _this2.onClickProjects();
	          } },
	        (0, _preact.h)(
	          'a',
	          { href: '', 'class': 'menu-item-submenu' },
	          'projects'
	        ),
	        (0, _preact.h)(
	          'ul',
	          { 'class': this.state.isSubmenuOpen ? 'submenu active' : 'submenu' },
